...
\subsection{Ledger-generated summary tables}
\label{sec:results-generated}

% Source: research/ledger.jsonl, read by application/paper_data.py alone. The tables below are not typed: they
% are written to paper/generated/*.tex by `pravrudhi paper-data`, which the publish path calls before every
% build, so they hold whatever the ledger contains at generation time rather than a number copied by hand. A
% benchmark, comparison or night the ledger does not yet report renders as a footnoted dash, never a blank cell.

\input{generated/external_benchmarks}

\input{generated/paired_comparisons}

\input{generated/nights}
